...
public class BasicGame implements GameLoop {
    ...
    static CreatingScene[] scene = new CreatingScene[8];
    int sceneCounter = 0;

    @Override
    public void init() {
        SaxionApp.playSound("BasicGame/resources/audio/Background Bubble Sound Effects(1).wav",true);
        ...
        scene[5] = new CreatingScene(10000, 10000, 150, 100, 800, 800, "BasicGame/resources/background ending.png", "BasicGame/resources/badEnding.png", false, false, "BasicGame/resources/BISH.png");
        scene[6] = new CreatingScene(10000, 10000, 150, 100, 800, 800, "BasicGame/resources/background ending.png", "BasicGame/resources/mediumEnding.png", false, false, "BasicGame/resources/BISH.png");
        scene[7] = new CreatingScene(10000, 10000, 150, 100, 800, 800, "BasicGame/resources/background ending.png", "BasicGame/resources/goodEnding.png", false, false, "BasicGame/resources/BISH.png");
